...
def praproses(virus_txt):
    ...
    yield report_back(55,'cleaning setelah disambiguasi depth 2 (interaksi serangga dan tanaman)')
    ...
    yield report_back(70,'cleaning tambahan')
    ...
    yield report_back(80,'cleaning tambahan')
    ...
    yield report_back(90,'cleaning tambahan')
    ...
    result = json.dumps({
        'message': 'Kirim json', 
        'df_node':df_node.to_json(),
        'df_edge':df_edge.to_json(),
        })
    yield f'data: {(result)}\n\n'
